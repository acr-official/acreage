                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Acreage Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Acr address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and acr: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Acreage Core"), this);
    aboutAction->setStatusTip(tr("Show information about Acreage Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Acr"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Acr addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Acr addresses"));
    ...
    openAction->setStatusTip(tr("Open a Acr: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Acreage Core help message to get a list with possible Acr command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Acreage Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Acr network", "", count));
}
...
{
    QString strTitle = tr("Acreage Core"); // default title
