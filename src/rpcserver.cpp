...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Acr features */
        {"acr", "masternode", &masternode, true, true, false},
        {"acr", "listmasternodes", &listmasternodes, true, true, false},
        {"acr", "getmasternodecount", &getmasternodecount, true, true, false},
        {"acr", "masternodeconnect", &masternodeconnect, true, true, false},
        {"acr", "masternodecurrent", &masternodecurrent, true, true, false},
        {"acr", "masternodedebug", &masternodedebug, true, true, false},
        {"acr", "startmasternode", &startmasternode, true, true, false},
        {"acr", "createmasternodekey", &createmasternodekey, true, true, false},
        {"acr", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"acr", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"acr", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"acr", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"acr", "getmasternodescores", &getmasternodescores, true, true, false},
        {"acr", "mnbudget", &mnbudget, true, true, false},
        {"acr", "preparebudget", &preparebudget, true, true, false},
        {"acr", "submitbudget", &submitbudget, true, true, false},
        {"acr", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"acr", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"acr", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"acr", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"acr", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"acr", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"acr", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"acr", "checkbudgets", &checkbudgets, true, true, false},
        {"acr", "mnsync", &mnsync, true, true, false},
        {"acr", "spork", &spork, true, true, false},
        {"acr", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"acr", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use acrd, or the -server option to acr-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> acr-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:3782/\n";
}
