...
In order to support loading of multiple wallets in acr-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is acr.cpp.
...
Changes to acr.cpp
----------------------
acr.cpp is the entry point into acr-qt, and as such, will require some minor modifications to provide hooks for
